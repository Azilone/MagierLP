        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 pb-8 md:pb-10 border-b border-gray-100">
          ...
          <div className="flex flex-col items-center md:items-start gap-6">
            <Link href="/" className="flex flex-col items-center md:items-start gap-2 group">
              ...
              <span className="font-black text-lg text-[#140F23] group-hover:text-[#5F1CFC] transition-colors">GetPawtrait</span>
            </Link>
            ...
            <div className="mt-2">
              ...
              <div className="flex gap-4 justify-center md:justify-start">
                <a href="#" aria-label="Twitter" className="text-gray-500 hover:text-[#5F1CFC] transition"><svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M22 5.924c-.793.352-1.645.59-2.54.698a4.48 4.48 0 0 0 1.963-2.475 8.94 8.94 0 0 1-2.828 1.082A4.48 4.48 0 0 0 12.03 9.03c0 .352.04.695.116 1.022C8.728 9.89 5.8 8.3 3.785 5.98a4.48 4.48 0 0 0-.606 2.254c0 1.555.792 2.93 2.002 3.736a4.48 4.48 0 0 1-2.03-.56v.057a4.48 4.48 0 0 0 3.6 4.393c-.193.053-.397.08-.607.08-.148 0-.292-.014-.432-.04a4.48 4.48 0 0 0 4.18 3.11A8.98 8.98 0 0 1 2 19.07a12.7 12.7 0 0 0 6.88 2.017c8.26 0 12.78-6.84 12.78-12.77 0-.195-.004-.39-.013-.583A9.1 9.1 0 0 0 24 4.59a8.98 8.98 0 0 1-2.6.713Z" /></svg></a>
                <a href="#" aria-label="Instagram" className="text-gray-500 hover:text-[#5F1CFC] transition"><svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><rect width="18" height="18" x="3" y="3" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1.5" fill="currentColor"/></svg></a>
                <a href="#" aria-label="LinkedIn" className="text-gray-500 hover:text-[#5F1CFC] transition"><svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><rect width="18" height="18" x="3" y="3" rx="2" /><path d="M7 10v4m0 0v4m0-4h.01M17 14v-2a2 2 0 0 0-2-2h-1a2 2 0 0 0-2 2v2m0 0v4m0-4h.01" strokeLinecap="round"/></svg></a>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 text-sm justify-center">
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="#services" className="text-gray-600 hover:text-[#5F1CFC] transition">Services</Link></li>
                <li><Link href="#customers" className="text-gray-600 hover:text-[#5F1CFC] transition">Customers</Link></li>
                <li><Link href="#pricing" className="text-gray-600 hover:text-[#5F1CFC] transition">Pricing</Link></li>
                <li><Link href="#company" className="text-gray-600 hover:text-[#5F1CFC] transition">Company</Link></li>
                <li><Link href="#how-it-works" className="text-gray-600 hover:text-[#5F1CFC] transition">How it works</Link></li>
                <li><Link href="/faq" className="text-gray-600 hover:text-[#5F1CFC] transition">FAQ</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-3 text-base uppercase tracking-wide">Resources</h4>
              <ul className="space-y-2">
                <li><Link href="/blog" className="text-gray-600 hover:text-[#5F1CFC] transition">Blog</Link></li>
                <li><Link href="/newsletter" className="text-gray-600 hover:text-[#5F1CFC] transition">Newsletter</Link></li>
                <li><Link href="/freebies" className="text-gray-600 hover:text-[#5F1CFC] transition">Freebies</Link></li>
                <li><Link href="#work" className="text-gray-600 hover:text-[#5F1CFC] transition">Our Work</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-6">
            ...
            <div>
              ...
              <div className="flex items-center justify-center md:justify-end gap-3 mt-3">
                ...
                <Image src={assets.images.brand.amex} alt="American Express from American Express" width={28} height={16} />
            ...
            <div className="mt-2 flex flex-col items-center md:items-end gap-2">
              <Image src={assets.images.brand.usa} alt="USA Flag" width={36} height={24} />
