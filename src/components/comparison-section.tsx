...
export function ComparisonSection() {
  return (
    <div className="flex flex-col items-center w-full bg-white">
      <div className="flex flex-col items-center w-full max-w-[1200px] py-28 px-5">
        <div className="flex flex-col items-center gap-20 w-full">
          {/* Header */}
          <div className="flex flex-col items-center max-w-[649.6px] text-center">
            <div className="flex flex-col items-center mb-4">
              <div className="text-[#5F1CFC] font-sans text-base leading-4 tracking-[-0.32px] py-[7.5px] px-[17px] rounded-[42px] border border-[#E5E5EA]">
                Comparison
              </div>
            </div>
            <div className="text-[#140F23] font-sans text-[66px] font-semibold leading-[72.6px] tracking-[-2.64px] max-lg:text-[50px] max-lg:leading-[55px] max-sm:text-[40px] max-sm:leading-[44px]">
              <div className="mb-5">What makes</div>
              <div className="flex items-center justify-center gap-[15px]">
                ...
                <div>
                  <svg
                    ...
                    className="w-[56px] h-[56px] max-lg:w-[45px] max-lg:h-[45px] max-sm:w-[35px] max-sm:h-[35px]"
                  >
                    <g clipPath="url(#clip0_1_18101)">
                      <mask
                        id="mask0_1_18101"
                      ...
                      >
                        <path
                          d="M56.1504 0.0595703H0.150391V56.0596H56.1504V0.0595703Z"
                          fill="white"
                        ></path>
                      </mask>
                      <g mask="url(#mask0_1_18101)">
                        <path
                          d="M7.94032 47.6138C10.2799 49.9534 11.3811 52.6453 10.4 53.6264L53.718 10.3084C54.6991 9.32733 53.5979 6.6354 51.2583 4.29584C48.9187 1.95628 46.2268 0.855033 45.2457 1.83614L1.92773 45.1541C2.90884 44.173 5.60077 45.2743 7.94032 47.6138Z"
                          fill="#5F1CFC"
                        ></path>
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M10.3944 53.6284C11.3755 52.6473 10.2743 49.9553 7.93474 47.6158C5.6386 45.3196 3.00305 44.2163 1.97852 45.1036L12.037 35.0451C13.0181 34.064 15.7101 35.1652 18.0496 37.5048C20.3458 39.8009 21.4491 42.4365 20.5618 43.461L10.3944 53.6284Z"
                          fill="#CBD2F3"
                        ></path>
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M43.6054 20.4213C44.5865 19.4402 43.4852 16.7483 41.1457 14.4087C38.8495 12.1126 36.214 11.0092 35.1895 11.8966L45.248 1.83809C46.2291 0.856987 48.921 1.95823 51.2606 4.29779C53.5567 6.59393 54.6601 9.22949 53.7727 10.254L43.6054 20.4213Z"
                          fill="#CBD2F3"
                        ></path>
                        <path
          ...
          {/* Comparison Table */}
          <div className="flex justify-center gap-2 w-full max-lg:flex-col max-lg:items-center">
            {/* Left Column - Categories */}
            <div className="flex-none w-[283px] py-[14px]">
              <div className="bg-white rounded-[32px] h-[584px] relative flex flex-col">
                <div className="flex flex-col items-start p-[104px_24px_0px_24px] gap-[27px]">
                  <CategoryItem text="Pricing" />
                  <CategoryItem text="Unlimited tasks" />
                  <CategoryItem text="Unlimited revisions" />
                  <CategoryItem text="Pre-qualified designers" />
                  <CategoryItem text="Time to start" />
                  <CategoryItem text="Processing time" />
                </div>
              </div>
            </div>

            {/* Magier Column - Highlighted */}
            <div className="flex-1 max-w-[283px] bg-[#5F1CFC] rounded-[48px] border-[14px] border-[#777CFD] p-[38px] relative">
              <div className="flex flex-col gap-[27px]">
                ...
                {/* Magier Column Items */}
                <ComparisonItem text="Fixed monthly price" isHighlighted />
                <ComparisonItem isHighlighted isCheckmark />
                <ComparisonItem isHighlighted isCheckmark />
                <ComparisonItem isHighlighted isCheckmark />
                <ComparisonItem text="&lt;2 days" isHighlighted />
                <ComparisonItem text="&lt;48h" isHighlighted />
              </div>
            </div>
...
function CategoryItem({ text }: { text: string }) {
  return (
    <div className="flex items-center gap-[6px]">
      ...
      <span className="text-[#140F23] text-[18px] leading-[27px] tracking-[-0.36px]">
        {text}
      </span>
    </div>
  );
...
function ComparisonItem({
  ...
  const baseClasses =
    "flex items-center justify-center min-h-[80px] border border-[#777CFD]";
  ...
  return (
    <div
      className={`${baseClasses} ${text ? "text-white text-[18px] leading-[27px] tracking-[-0.36px]" : ""}`}
    >
      {text}
    </div>
  );
...
function ComparisonColumn({
  ...
  return (
    <div className="flex-1 max-w-[283px] py-[14px]">
      <div className="bg-white rounded-[32px] h-[584px] relative flex flex-col">
        <div className="p-6 flex flex-col">
          <div className="text-[#140F23] text-[24px] leading-[30px] tracking-[-0.96px] text-center mb-[27px]">
            {title}
          </div>
          <div className="flex flex-col gap-[27px] border border-[#E5E5EA] pt-[27px]">
            {items.map((item, index) => (
              <div
                key={index}
                className={`${
                  typeof item === "string"
                    ? "text-[#828088] text-[18px] leading-[27px] tracking-[-0.36px]"
                    : "flex items-center justify-center"
                } min-h-[80px] border border-[#E5E5EA]`}
              >
                {item}
              </div>
            ))}
...
function CheckmarkIcon({ isGray = false }: { isGray?: boolean }) {
  return (
    <svg
      width="25"
      height="25"
    ...
    >
      <path
        ...
        fill={isGray ? "none" : "white"}
        stroke={isGray ? "#828088" : "white"}
        strokeWidth="1.5"
        strokeLinecap="round"
